...
#pragma INLINE 
static fix16_t fix16_from_int(int a)     { return a * fix16_one; }
#pragma INLINE 
static float   fix16_to_float(fix16_t a) { return (float)a / fix16_one; }
#pragma INLINE 
static double  fix16_to_dbl(fix16_t a)   { return (double)a / fix16_one; }

#pragma INLINE 
static int fix16_to_int(fix16_t a)
{
...
#pragma INLINE 
static fix16_t fix16_from_float(float a)
{
...
#pragma INLINE 
static fix16_t fix16_min(fix16_t x, fix16_t y)
	{ return (x < y ? x : y); }
#pragma INLINE 
static fix16_t fix16_max(fix16_t x, fix16_t y)
	{ return (x > y ? x : y); }
#pragma INLINE 
static fix16_t fix16_clamp(fix16_t x, fix16_t lo, fix16_t hi)
...
#pragma INLINE 
static fix16_t fix16_add(fix16_t inArg0, fix16_t inArg1) { return (inArg0 + inArg1); }
#pragma INLINE 
static fix16_t fix16_sub(fix16_t inArg0, fix16_t inArg1) { return (inArg0 - inArg1); }
...
#pragma INLINE 
static fix16_t fix16_rad_to_deg(fix16_t radians)
	{ return fix16_mul(radians, fix16_rad_to_deg_mult); }

static const fix16_t fix16_deg_to_rad_mult = 1144;
#pragma INLINE 
static fix16_t fix16_deg_to_rad(fix16_t degrees)
...
*/
#pragma INLINE 
static fix16_t fix16_sq(fix16_t x)
